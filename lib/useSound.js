...
exports.SoundyProvider = exports.SoundyContext = void 0;
...
var SoundyContext = exports.SoundyContext = /*#__PURE__*/(0, _react.createContext)();
var SoundyProvider = exports.SoundyProvider = function SoundyProvider(_ref) {
  var children = _ref.children,
    playerRef = _ref.playerRef,
    _ref$bufferSize = _ref.bufferSize,
    bufferSize = _ref$bufferSize === void 0 ? 256 : _ref$bufferSize;
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!audioContext.current) {
      ...
      analyser.current.fftSize = bufferSize;
  ...
  return /*#__PURE__*/_react["default"].createElement(SoundyContext.Provider, {
    value: {
